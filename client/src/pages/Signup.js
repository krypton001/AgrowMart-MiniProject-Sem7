  ...
  return (
    <div className='m-auto w-[90%] grid grid-cols-1 md:grid-cols-3 items-center h-[100%]'>
        <div className='col-span-1 md:col-span-2'>
            <h1 className='text-xl md:text-3xl font-semibold text-center mb-4'>Get Started with AgrowMart!</h1>
            <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col items-center text-sm md:text-md mt-10 md:mt-16'>
                <div className='md:grid md:grid-cols-2 md:gap-10 w-[80%] justify-center'>
                    <div className='md:col-span-1 flex flex-col'>
                        ...
                        <input type="text" className='text-md border-[1.5px] border-slate-400 rounded-md mt-1 mb-10 px-2 py-3' placeholder="Name" {...register("Name", {required: true, maxLength: 100})} />
                    ...
                    <div className='md:col-span-1 flex flex-col'>
                        ...
                        <label htmlFor="Role" className='font-semibold text-slate-500'>Role</label>
                        <div className='mt-1 mb-10 flex flex-row h-[100%] items-center'>
                            <input {...register("Role")} type="radio" value="Farmer" className='cursor-pointer w-6 h-6 mr-2'/>
                            <label htmlFor="Farmer">Farmer</label>
                            <input {...register("Role")} type="radio" value="Shopper" className='cursor-pointer w-6 h-6 mr-2 ml-6' />
                ...
                <p className='mt-3 text-lg'>Already have an account? <span className='cursor-pointer text-[#3B8056] font-bold' onClick={handleGoToLogin}>Login</span></p>
            </form>
        </div>
